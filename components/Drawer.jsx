  ...
  return (
    ...
    >
      <button onClick={closeDialog} className="bg-white rounded-full px-5">
        <div
          class="absolute top-10 right-10 w-6 xxl:w-10 h-6 xxl:h-10 cursor-pointer"
          id="navigationClose"
        >
          <span class="absolute left-0 top-1/2 -translate-y-1/2 w-6 xxl:w-10 h-[0.125rem] xxl:h-1 -rotate-45 bg-black"></span>
          <span class="absolute left-0 top-1/2 -translate-y-1/2 w-6 xxl:w-10 h-[0.125rem] xxl:h-1 rotate-45 bg-black"></span>
        </div>
      </button>
