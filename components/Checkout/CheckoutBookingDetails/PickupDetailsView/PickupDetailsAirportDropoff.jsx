...
const PickupDetailsAirportDropoff = (props) => {
  ...
  return (
    <div className="leading-relaxed pb-8">
      ...
      <p>
        From: <span className="font-bold">{hotelName}</span>
      </p>
      <p>
        To: <span className="font-bold">{airportName} </span>
      </p>
      <p>
...
export default PickupDetailsAirportDropoff;
